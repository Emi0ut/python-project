...
df = pd.read_csv("/Users/abhimanyutarar/Downloads/python dataset.csv")
...
print("Electric Range Summary:", range_stats)
...
print("MSRP Statistics by Vehicle Type:", msrp_stats)

#
# # Obj. 4 - Correlation Between Numerical Features
numerical_df = df.select_dtypes(include=['int64', 'float64'])
correlation_matrix = numerical_df.corr()
print("Correlation Matrix for Numeric Features:", correlation_matrix)
#
#
...
plt.pie(ev_type_counts, labels=ev_type_counts.index, autopct='%1.1f%%', colors=sns.color_palette('pastel'))
